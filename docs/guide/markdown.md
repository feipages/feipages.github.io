...
本文介绍markdown语法。部分语法为非标准语法，为GitHub对markdown的扩充语法，称之为`GitHub Flavored Markdown`。简称`GFM`，大家在使用过程中注意验证。
...
|#|语法|效果|
|---|----|-----|
|1|`[必应](https://www.bing.com "悬停显示")`|[必应](https://www.bing.com "悬停显示")|
...
|语法|效果|
|----|-----|
|`[我的简介](/example/profile.md)`|[我的简介](./profile.md)|
